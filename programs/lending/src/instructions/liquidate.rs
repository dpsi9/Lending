...
pub struct Liquidate<'info> {
    ...
    pub borrowed_token_account: InterfaceAccount<'info, TokenAccount>,
    #[account(
        mut,
...
pub fn process_liquidate(ctx: Context<Liquidate>) -> Result<()> {
    ...
    collateral_bank.liquidation_close_factor;
    ...
    let cpi_transfer_bank_accounts = TransferChecked {
    ...
    let cpi_ctx_to_bank = CpiContext::new(cpi_program.clone(), cpi_transfer_bank_accounts);
